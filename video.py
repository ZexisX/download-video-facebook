...
# Global variables for terminal colors
...
# Function to calculate program runtime
def start():
    global Mulai_Jalan
...
def finish():
    ...
    try:
        ...
        print('\nProgram completed in %s minutes %s seconds\n' % (Menit, Detik))
    except Exception as e:
...
class get_url:
    def __init__(self):
        ...
        print("%sType 'set' To Set Video Storage"%(P))
        irl = input('%sEnter URL : '%(P))
...
# Class for downloading and saving video
class savendown:
    ...
    def move(self):
        try:
            ...
            print('\n%sSuccessfully Saved To : %s%s%s'%(P,H,xd,P))
        except Exception as e:
            pass
